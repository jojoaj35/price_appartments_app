...
class ApartmentService():
    def __init__(self):
        self.path_model ="/Users/joelwilson/price_appartments_app/artifacts/randomForestForApartmentPrice.pkl"
        self.path_encoder = '/Users/joelwilson/price_appartments_app/artifacts/neighbourhood_encoder.pkl'
...
"""if __name__ =="__main__":
    test_request = ApartmentRequest(rooms = 2, size= 54, bathrooms = 1, neighbourhood='Manastur', year_built=1999)
